<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="admin_DocumentPdf.aspx.cs" Inherits="admin_module_admin_DocumentPdf" %>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body d-flex align-items-center">
                                <h4 class="box-title mr-3">PDF</h4>
                                <button class="btn btn-primary mr-2" data-toggle="modal" data-target="#ModalAdd"><i class="fa fa-plus"></i> PDF</button>
                                <div class="search-name">
                                    <label for="inputPassword2" class="sr-only">Tên PDF</label>
                                    <input type="text" class="form-control" placeholder="Tên PDF" />
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-hdong btn-view" href="pdf.html"><i
                                                            class="fa fa-eye"></i></a>&nbsp;<a
                                                        class="btn btn-hdong btn-copy" href="#"><i
                                                            class="fa fa-copy"></i></a>&nbsp;<a
                                                        class="btn btn-hdong btn-save" href="#"><i
                                                            class="fa fa-check"></i></a>&nbsp;<a
                                                        class="btn btn-hdong btn-edit" href="#"><i
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title"><strong>Thêm PDF </strong></h4>
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="form-group upload-btn">
                                    ...
                                    <div class="flat-color-4"><i class="icofont-file-pdf"></i></div>
